...
plt.subplot(2, 2, 2)
dwave.graphs.draw_chimera(C, with_labels=True)
...
plt.subplot(2, 2, 3)
dwave.graphs.draw_chimera_embedding(C, embedding, with_labels=True)
...
embedding = minorminer.find_embedding(K3, C, suspend_chains=suspend_chains)
plt.subplot(2, 2, 4)
dwave.graphs.draw_chimera_embedding(C, embedding, show_labels=True)
